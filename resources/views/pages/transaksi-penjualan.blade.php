...
<div class="page-title d-flex flex-column gap-1 me-3 mb-2">
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold mb-6">
        ...
        <li class="breadcrumb-item text-gray-700 fw-bold lh-1"> Pendapatan </li>
                    ...
                    <div class="flex-lg-row-fluid me-xl-18 mb-10 mb-xl-0">
                        ...
                        <div class="mt-n1">
                            ...
                            <div class="d-flex flex-stack pb-10">
                                ...
                                <!--end::Logo-->
                                <!--begin::Action-->
                                <span class="badge badge-light-success badge-lg"> Pendapatan </span>
                                <!--end::Action-->
                            </div>
                            <!--end::Top-->
                            <!--begin::Wrapper-->
                                        ...
                                        <table class="table mb-3">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="fw-bold text-gray-700 fs-5 text-end">
                                                    ...
                                                    <i class="fa fa-genderless text-success fs-2 me-2" data-bs-toggle="tooltip" title="{{$B->category}}"></i>{{$B->name}}</td>
                                                    <td class="pt-6">{{$B->category}}</td>
                                                    <td class="pt-6">{{$B->total_quantity}}</td>
                                                    <td class="pt-6 text-dark fw-bolder">Rp{{number_format($B->total_price,2)}}</td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
