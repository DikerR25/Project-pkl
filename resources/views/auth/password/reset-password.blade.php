						...
						<div class="w-lg-500px p-10 p-lg-15 mx-auto">
							...
							<form class="form w-100" action="{{ route('password.update')}}" method="post">
								...
								<div class="text-center mb-10">
									...
									<a class="link-primary fw-bold">Create your new password</a></div>
									<!--end::Link-->
								...
								<div class="fv-row mb-10">
									...
									<!--end::Label-->
									<!--begin::Input-->
									<input class="form-control form-control-lg form-control-solid" type="password" name="password_confirmation" autocomplete="on" />
									<!--end::Input-->
									@error('password')
										<small>{{ $message }}</small>
									@enderror
